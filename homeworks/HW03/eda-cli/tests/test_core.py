...
def _my_sample_df() -> pd.DataFrame:
    return pd.DataFrame({
        "user_id": [100, 101, 102, 104, 104, 105, 106, None],
        "country": ["RU", "UZ", "MN", "RK", "RP", "JP", "CN", "GB"],
        "GDP": [10000000, None, 10000, None, None, None, 100000, -10],
        "average_salary": [1000.0, 24.5, 246.7, 2421.4, None, 245.6, 743.8, 0.0]
    })
